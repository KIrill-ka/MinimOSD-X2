...
#define MAX7456_HOS_reg   0x02 // horizontal offset
...
class OSD: public BetterStream
{
  public:
    ...
    void char_write_end(void);
    void char_write_start(uint8_t char_n);
    void char_write_byte(uint8_t byte_offs, uint8_t data);
